...
echo "This script will create a Gennie release, based of the current 'develop' branch."
...
echo "Version ${VERSION} was succesfully released. On Github you can complete the release: https://github.com/inventid/gennie/releases/tag/${VERSION}"
